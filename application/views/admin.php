...
<head>
	...
	<script type="text/javascript">
		...
		var dcanvas = <?php echo json_encode($canvas); ?>;
		var devvas = <?php echo json_encode($devvas); ?>;
		var clips = <?php echo json_encode($clips); ?>;
	</script>
</head>
				...
				<div class="accordion-group">
				  ...
				  <div id="collapseOne" class="accordion-body collapse in">
				    <div class="accordion-inner">
						...
						<div data-id="<?php echo $cate[$i]["id"]; ?>" class="accordionButton"><?php echo $cate[$i]["name"]; ?> <i class="moredv icon-question-sign"></i></div>
							<div class="accordionContent" style="display: none;">
								<ul class="device_item branditem">
								<?php for($j = 0; $j < count($subcate); $j++)
									if($subcate[$j]["categoryid"]==$cate[$i]["id"]){ ?>
									<li data-id="<?php echo $subcate[$j]["id"]; ?>" class="subheader"><?php echo $subcate[$j]["name"]; ?></li>
									<?php for($x = 0; $x < count($device); $x++) 
										if($device[$x]["sub_categoryid"]==$subcate[$j]["id"]){ ?>
									<li data-id="<?php echo $device[$x]["id"]; ?>"><?php echo $device[$x]["name"]; ?></li>
								<?php }} ?>
								</ul>
							</div>
						<?php } ?>
...
<!--...............................................Colum two.......................................................................-->
		...
		<div id="col2" class="span9 row12">
	        ...
	        <div id="cellctr" style="position: absolute;top:60px;margin-left:20px; display:block;width:200px;">
		        ...
		        <div id="grid" class="btn btn-small btn-info" style="margin:4px 0 0 -5px;padding: 2px 4px;"><i class="icon-th" style="padding-right: 2px"></i></div><br>
		 ...
		 <div class="modal-header">
		  ...
		  <div class="modal-body">
		   ...
		   <div class="modal-footer">
		    <a onclick="callClose();" class="btn">Close</a>
		    <a onclick="AcceptLayout();" class="btn btn-primary">Create</a>
		  </div>
	</div>
<!--...............................................Image Gallery...................................................................-->
