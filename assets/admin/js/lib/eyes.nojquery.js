...
function jseyesmove(x, y) {
  ...
  if (jseyeso && jseye1 && jseyeso.style) {
    ...
    yleft = r*dx+36.5;
    ytop = jseyeso.offsetTop+r*dy;
    if(ytop < 415) ytop=415; if(ytop > 429) ytop=429;
    if(yleft < 35) yleft=35; if(yleft > 42) yleft=42;
    jseye1.style.left= yleft+'px'; jseye1.style.top= ytop+'px';
    ex+=56; dx-=56;
    r=(dx*dx/49+dy*dy/289<1) ? 1 : Math.sqrt(49*289/(dx*dx*289+dy*dy*49));
